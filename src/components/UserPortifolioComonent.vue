<template >
    <div class="">
        ...
        <div class="border rounded  d-flex flex-wrap m-3 mt-4">
...
<style scoped >@import url('https://fonts.googleapis.com/css2?family=Dancing+Script&family=Lobster&display=swap');</style>