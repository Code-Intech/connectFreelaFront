<template>
    <div class="col-10 h-100 d-inline-block">
        ...
        <div>
            ...
            <div v-if="store.getters.StatePrestador.prestadorInfo.idtb_prestador >= 1" class="d-flex justify-content-end">
...
export default {
    ...
    methods: {
        ...
        teste() {
            ...
            console.log(this.infoPrestador.Profissao, "infoPrestadorprofissao");
